...
function $main(options) {
     ...
     *
     * The library cannot be used after making this call, or else it will throw all kinds of errors.
     *
     * If you ever need to terminate the library explicitly, you must do it only before exiting the application.
     *
