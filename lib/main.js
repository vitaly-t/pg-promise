 ...
 * This property can be set dynamically (before or after initialization).
 *
 * @param {string} [options.poolStrategy='server']
 * ** This is a $[6.x] feature. **
 *
 * Pool allocation strategy. See {@link PoolStrategy} for details.
 *
...
function $main(options) {
    ...
    if ($npm.utils.isNull(options)) {
        ...
        var validOptions = ['pgFormatting', 'pgNative', 'promiseLib', 'noLocking', 'capSQL', 'noWarnings',
            'connect', 'disconnect', 'query', 'receive', 'task', 'transact', 'error', 'extend', 'poolStrategy'];
     ...
     * @description
     *
     * Shuts down all connection pools currently allocated (call it when exiting the application).
     *
