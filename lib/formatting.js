...
var $as = {
    ...
    date: function (d, raw) {
        ...
        if (d instanceof Date) {
            ...
            throw new Error(wrapText(d) + " is not a Date object.");
        }
    },
    number: function (num) {
        if (isDBNull(num)) {
        ...
        if (typeof(num) !== 'number') {
            throw new Error(wrapText(num) + " is not a number.");
        }
        if (isFinite(num)) {
            return num.toString();
        }
    ...
    array: function (arr) {
        ...
        if (arr instanceof Array) {
            ...
            throw new Error(wrapText(arr) + " is not an Array object.");
        }
    },
    func: function (func, raw, obj) {
        ...
        if (typeof(func) !== 'function') {
            throw new Error(wrapText(func) + " is not a function.");
        }
        if (isDBNull(obj)) {
            return formatValue(func(), raw);
        } else {
            if (typeof(obj) !== 'object') {
                throw new Error(wrapText(obj) + " is not an object.");
            }
