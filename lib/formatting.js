...
const $as = {
     ...
     * ** Added in v7.1.0 **
     *
     * Namespace for symbols used by $[Custom Type Formatting], available from `pgp.as.ctf` before and after initializing the library.
     *
     * It was added to avoid explicit extension of types that need to be used as formatting parameters, to keep their type signature intact.
     *
     ...
     * Property name for the $[Custom Type Formatting] flag `rawType`, plus legacy flag `_rawType`.
     *
     * @example
     ...
     * class MyType {
     *     constructor() {
     *         this[ctf.rawType] = true; // when you expect Raw Text return from toPostgres
     *     }
     *
     *     [ctf.toPostgres](self) {
     *         // self = this
