...
// undefined, array and object;
// When value type is not supported, it returns null,
// which is only possible when the value is a function.
...
//
// 1. format "$1, $2, etc", when 'values' is simple (string, boolean, number, date or null)
