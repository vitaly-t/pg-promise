...
class TransactionMode {
    ...
    constructor(obj) {
        // TODO: Update tests, documentation + TypeScript
        //  perhaps add error when it is not an object.
        obj = obj || {};
        assertOptions(obj, ['tiLevel', 'deferrable', 'readOnly']);
        let {tiLevel, readOnly, deferrable} = obj;
