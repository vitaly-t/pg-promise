...
class PreparedStatement extends ServerFormatting {
    ...
    // TODO:
    //  1. Should not allow construction without name+text, and be consistent with TypeScript declaration
    //  2. Advanced properties should be documented
