...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         * @description
         * Executes a query that expects 0 or 1 rows, to resolve with the row-object when found,
         * and with `null` when not found. When the query returns more than 1 row, the method rejects.
         *
         * When receiving a multi-query result, only the last result is processed, ignoring the rest.
         *
         * @param {string|function|object} query
