...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         *
         */
        obj.tx = function (options, cb) {
            return taskProcessor.call(this, p1, p2, true);
        };

        // Changes for all methods:
        // 1. If options is of type string, it is a tag; Otherwise it is an Options object.
        // 2. Introduce 'mode' into the transaction options, remove txMode from the callback.

        obj.txIf = function (options, cb) {
            return taskProcessor.call(this, p1, p2, !obj.ctx || !obj.ctx.inTransaction);
        };
