...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         * - Custom `map` implementation offers much better performance than the standard {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map Array.map}
