...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         * or else start a task, which is the same as the following:
         *
         * ```js
         ...
         * Transaction mode to configure the transaction-opening command.
         *
         ...
         *
         * @param {Function|generator} cb
         * Transaction/task callback function (or $[ES6 generator]), to return the result that will determine either
         * success or failure for the operation.
         *
         * It can be either the first of the second parameter passed into the method.
         *
         * @returns {external:Promise}
