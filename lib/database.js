...
function Database(cn, dc, config) {
     ...
     * @deprecated
     * Methods {@link Database.task task} ({@link Database.tx tx} for transactions) offer a safer, automatic way of using a shared connection.
     *
     * @summary Acquires a new or existing connection from the pool, based on the current
     ...
     * A newer and safer approach is via method {@link Database.task task} ({@link Database.tx tx} for transactions),
