...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
        ...
        // Changes for all methods:
        // 1. If options is of type string|number, it is a tag; Otherwise it is an Options object.
        // 2. Introduce 'mode' into the transaction options, remove txMode from the callback.
         ...
         * or else start a task, i.e. the default is defined as this:
         *
         * ```js
         ...
         * This parameter is completely optional, and presumed skipped when the first parameter is a function (`cb` parameter).
         *
         * When it is of type `string` or `number`, it is assumed to be option `tag` passed in directly.
         * Otherwise, it is expected to be an object with options as listed below.
         *
