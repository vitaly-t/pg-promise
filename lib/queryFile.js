 ...
 * as the IO is a very expensive resource. Starting from version 5.8.0, if you do not follow it, then while in `debug`
 * mode, you will be seeing the following warning: `Creating a duplicate QueryFile object for the same file`, to signal
 * a bad usage pattern.
 *
 * @param {string} file
