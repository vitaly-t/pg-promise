...
/**
 * @constructor ParameterizedQueryError
 * @augments Error
 * @description
 * ParameterizedQueryError class, available from the {@link errors} namespace.
 *
 * This type represents all errors caused by {@link ParameterizedQuery}, whether it is used explicitly
 * or implicitly (via simple `{text, values}` object).
 *
 ...
 *
 * @returns {ParameterizedQueryError}
...
/**
 * @method ParameterizedQueryError.toString
 * @description
