 ...
 *
 * @property {String|Array} [include]
 * Either a single string with a property name, or an array of strings.
 *
 * By default, all properties are used as insert values. But if `include` is set to a string or
 * an array, then only the specified properties will be used, ignoring the rest.
 *
