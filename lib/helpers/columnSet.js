...
function ColumnSet(columns, options) {
     ...
     * @description
     * Returns the complete list of SET assignments for a single object.
     *
     * This method is primarily for internal use.
     *
     * @param {object} obj
     * Object that contains all the values according to the columns configuration.
     *
     * @returns {string}
     * Comma-separated list of value-to-variable assignments.
     */
    this.assign = function (obj) {
        if (!obj || typeof obj !== 'object') {
            // TODO: This needs testing + documentation.
