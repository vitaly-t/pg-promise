 ...
 *
 * The generated query is logically incomplete, as it does not include a `WHERE` condition to determine which records
 * are to be updated. This is why this method supports options `tableAlias` and `valueAlias` for multiple-object updates,
 * to allow custom aliases when appending to the resulting query.
 *
 ...
 * // Adding negation '!' means it is a condition column, not to be updated:
