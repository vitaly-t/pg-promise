 ...
 * Name of the source property, if different from the column's name.
 *
 * @property {string} mod
 * Formatting modifier.
 *
 * @property {} def
 * Default value. Used only when the source object doesn't have the property.
 *
