...
function Task(ctx, tag, isTX) {
    ...
    // Resolves a predefined array of mixed values by redirecting to the
    // method within the spex module. See the spex method documentation:
    // https://github.com/vitaly-t/spex/blob/master/docs/code/batch.md
    this.batch = function (values, cb) {
        return npm.spex.batch.call(this, values, cb);
    };

    // Resolves a dynamic sequence of mixed values by redirecting to the
    // method within the spex module. See the spex method documentation:
    // https://github.com/vitaly-t/spex/blob/master/docs/code/sequence.md
