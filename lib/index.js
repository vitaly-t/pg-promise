 ...
 * @constructor Task
 * @extends Database
 * @summary Extends {@link Database} for an automatic connection session,
 * with methods for executing multiple database queries.
 * @description
...
var $notify = {
     ...
     *
     * Notification happens just before the query execution. And if the handler throws an error,
     * the query execution will be rejected with that error.
     *
