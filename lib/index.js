...
function Database(cn, options) {
    ...
    $extend(new Context(cn, options), this); // extending root protocol;
}
...
////////////////////////////
// Transaction type;
function tx(parentCtx, p1, p2) {

    var tag, // tag object / value;
        cb = p1, // callback function;
        ctx = parentCtx.clone(); // transaction context object;
    // TODO: Need to test that cloning here is necessary;
    ...
    var txInst = new Transaction(ctx, tag);
...
// to be passed into tx as parameter/context;
