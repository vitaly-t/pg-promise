...
function Database(cn, options) {
    ...
    this.connect = function () {
        var cnCtx = new Context(cn, options);
        var cnInst = {
    ...
    this.query = function (query, values, qrm) {
        var dbCtx = new Context(cn, options);
    ...
    var ctx = new Context(cn, options);

    $extend(ctx, this); // extending root protocol;
}
...
function Transaction(ctx, p1, p2) {
    ...
    var tag, // tag object / value;
        cb = p1, // callback function;
        self = this, // this class instance;
    ...
    $extend(txCtx, this); // extending transaction protocol;
