...
function $extend(ctx, obj) {
     ...
     * @param query{(string|object)} - query to be executed
     * @param values{array|value} - query formatting parameters
     * @returns A promise object that represents result of the query.
     *
     * When no records are returned, the returned promise will resolve with **undefined**
     *
     * When the query returns any data, it will reject with message: *No return data was expected from the query*.
     */
