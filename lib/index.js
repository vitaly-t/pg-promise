...
function Library(options) {
    ...
    var ext = self.createDB;

    ext.on = function (event, func) {
...
Library.prototype.__proto__ = npm.events.EventEmitter.prototype;
Database.prototype.__proto__ = npm.events.EventEmitter.prototype;
