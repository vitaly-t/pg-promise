...
queryResult = {
    ...
    /** Expecting no rows. */
    none: 4,
    /** many|none - any result is expected. This is the default. */
    any: 6
};
...
function Database(cn, options) {
     ...
     * @param qrm{queryResult} - query result mask
...
function $extend(ctx, obj) {
     ...
     * @param query{string|object} - query string or prepared statement object
     * @param values{array|value} - formatting parameters for the query string
     * @returns {Promise} - same as method {@link Database#manyOrNone manyOrNone}
     * @see {@link module:pg-promise.Database#manyOrNone Database.manyOrNone}
     */
     ...
     * @param query{string|object} - query string or prepared statement object
     * @param values{array|value} - formatting parameters for the query string
     * @returns {Promise} - same as method {@link Database#result result}
     * @see {@link module:pg-promise.Database#result Database.result}
     */
     ...
     * @param qs - stream object of type `pg-query-stream`
     * @param init - stream initialization callback
     * @returns {Promise} - result of the streaming operation.
     *
     * Once the streaming has finished successfully, the method resolves with
     * <code>\{processed, duration\}</code>:
     ...
     * @param funcName{string} - name of the function to be executed.
     * @param values{array|value} - parameters for the function.
     * @param qrm{queryResult} - Query Result Mask.
     * @returns {Promise} - the query result, according to `qrm`.
     * @see {@link module:pg-promise.Database#query Database.query}
     */
     ...
     * @param procName{string} - name of the stored procedure to be executed.
     * @param values{array|value} - parameters for the procedure.
     * @returns {Promise} - same result as method {@link module:pg-promise.Database#oneOrNone oneOrNone}.
     * @see {@link module:pg-promise.Database#oneOrNone Database.oneOrNone}
     * @see {@link module:pg-promise.Database#func Database.func}
     */
     ...
     * @method task
     * @memberof module:pg-promise.Database.prototype
     * @summary Provides an automatic connection for executing a callback function.
     * @param p1 {object|function} - a tag object, if it is not `undefined` and at least
     * two parameters are passed, or else it is the callback function for the task.
     * @param p2 {function} - task callback function, but only if p1 was passed in also,
     * and it wasn't `undefined`, or else p2 has no meaning.
 ...
 */
$main.version = new Version(1, 9, 4);
