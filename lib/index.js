...
function $extend(ctx, obj) {
     ...
     * @returns A promise, as a result of the streaming operation.
     *
     ...
     * @param qrm{queryResult} - Query Result Mask.
     * @returns The same result as method {@link module:pg-promise.Database#oneOrNone oneOrNone}.
    ...
    function taskProcessor(p1, p2, isTX) {
        ...
        if (tag === undefined && taskCtx.cb.tag !== undefined) {
 ...
 */
$main.version = new Version(1, 9, 1);
