...
function $extend(ctx, obj) {
     ...
     * - when any data is returned, it rejects with {@link module:pg-promise~QueryResultError QueryResultError}
     ...
     * - when no rows are returned, it rejects with {@link module:pg-promise~QueryResultError QueryResultError}
     * = `No data returned from the query.`
     * - when multiple rows are returned, it rejects with {@link module:pg-promise~QueryResultError QueryResultError}
...
var rootNameSpace = {
     ...
     * @alias module:errors
     * @member {module:errors} QueryResultError
     * @readonly
     */
     ...
     * @alias module:errors
     * @member {module:errors} SQLParsingError
     * @readonly
     */
    SQLParsingError: $npm.errors.SQLParsingError,
    ...
    /**
     * Query File.
     * @alias module:queryFile
     * @member {module:queryFile} QueryFile
     * @readonly
     */
...
$npm.utils.lock(rootNameSpace.SQLParsingError, true);
