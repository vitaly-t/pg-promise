...
function $main(options) {
    ...
    var inst = function (cn) {
        ...
        if (cn && (t === 'string' || t === 'object')) {
            return new Database(cn, options, config);
        }
...
var rootNameSpace = {
    ...
    /**
     * Namespace for the {@link formatting type conversion helpers}.
     ...
     *
     * If you want to access the $[Native Bindings], use `pgp.pg.native`.
     *
    ...
    /**
     * {@link queryResultErrorCode} type.
     * @member {queryResultErrorCode} queryResultErrorCode
     * @readonly
     */
    queryResultErrorCode: $npm.errors.queryResultErrorCode,

    /**
     * {@link PromiseAdapter} type.
