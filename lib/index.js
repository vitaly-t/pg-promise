...
function $query(ctx, query, values, qrm, options) {
    return $p(function (resolve, reject) {
        ...
        if (errMsg) {
            ...
            try {
                ctx.client.query(query, params, function (err, result) {
                    if (err) {
...
function $notifyError(err, options, ctx) {
    if (options && options.error) {
        ...
        try {
            func(err.message || err, ctx); // notify the client;
        } catch (err) {
